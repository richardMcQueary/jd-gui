...
public class ConfigurationXmlPersisterProvider implements ConfigurationPersister {
    ...
    public Configuration load() {
        ...
        setAllUIFonts(new javax.swing.plaf.FontUIResource("Dialog", Font.PLAIN, fontSizePackageTree));
        ...
        UIManager.put("Viewport.foreground", Color.MAGENTA);      
